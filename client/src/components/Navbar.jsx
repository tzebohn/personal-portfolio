        ...
        >
            ...
            <NavLink to="/" className="cursor-pointer"> 
                <svg className="h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 498 127" fill="none">
                    ...
                    <path d="M387.763 108.56L421.843 18.32H430.963L396.883 108.56H387.763Z" fill="white"/>
                    <path d="M447.16 91.76V83.408L476.92 68.816C478.136 68.24 479.256 67.76 480.28 67.376C481.368 66.928 482.168 66.64 482.68 66.512C482.104 66.384 481.272 66.128 480.184 65.744C479.096 65.296 478.008 64.784 476.92 64.208L447.16 49.52V40.88L488.44 61.52V71.12L447.16 91.76Z" fill="white"/>
                </svg>
            </NavLink>
